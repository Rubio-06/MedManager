        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateBirthday = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    SocialSecurityNumber = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineAllergies", x => new { x.MedicineId, x.AllergyId });
                    table.ForeignKey(
                        name: "FK_MedicineAllergies_Allergies_AllergyId",
                        column: x => x.AllergyId,
                        principalTable: "Allergies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicineAllergies_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineHistories", x => new { x.MedicineId, x.HistoryId });
                    table.ForeignKey(
                        name: "FK_MedicineHistories_Histories_HistoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientAllergies_Persons_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientHistories", x => new { x.PatientId, x.HistoryId });
                    table.ForeignKey(
                        name: "FK_PatientHistories_Histories_HistoryId",
                        column: x => x.HistoryId,
                        principalTable: "Histories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientHistories_Persons_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineAllergies_AllergyId",
                table: "MedicineAllergies",
                column: "AllergyId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineHistories_HistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientHistories_HistoryId",
